...
📄 소스: `data/mental_breaks.json` | 분류: data | 유형: object

## 개요

- 설정 내용: `data` 데이터 도메인 설정 값. Configuration values for the `data` data domain.
- 읽는 시스템/모듈: mental_break
- 관련 문서: [`mental_break`](../../systems/mental_break.md)
