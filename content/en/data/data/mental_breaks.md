...
- Configures: `data` 데이터 도메인 설정 값. Configuration values for the `data` data domain.
- Read by systems/modules: mental_break
- Related documentation: [`mental_break`](../../systems/mental_break.md)
