...
📄 source (출처): `data/species/human/mortality/siler_parameters.json` | Category (분류): species/human/mortality | Type (유형): object

## 개요 (Overview)

- Configures (설정 내용): 종족 사망률 위험도와 생존 보정값. Species mortality hazards and survival modifiers.
- Read by systems/modules (읽는 시스템/모듈): species_manager
- Related documentation (관련 문서): [`mortality`](../../../../systems/mortality.md)
...
### 계절 환경 영향 (Seasonal Environment Effects)
